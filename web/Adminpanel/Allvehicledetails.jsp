                    ...
                    <div class="page-title-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All vehicle details</li>
                            </ol>
                        </nav>
                    </div>
                                                    ...
                                                    <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Type</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Number</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Driver Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Driver Reg</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td><%= avbz.getVehumber()%></td>

                                                                <td><%= avbz.getType()%></td>
                                                                <td><%= avbz.getVehiclename()%></td>
                                                                <td><%= avbz.getVehumber()%></td>
                                                                <td><%= avbz.getDname()%></td>
                                                                <td><%= avbz.getDregno()%></td>
                                                                <td><%= avbz.getBranchz()%></td>
                                                                <td><input type="button" value="Remove" class="btn btn-danger" onclick="Removevehcle(<%= avbz.getId() %>)"></td>
                ...
                $.post("../RemoveVehicle",
                        ...
                        function(data, status) {
                            if (data == "alread") {
                                ...
                                swal("Done!Vehicle Removed..!", {
                                    icon: "success",
                                });
                                window.location = "Allvehicledetails.jsp";
                            }
                            else {
