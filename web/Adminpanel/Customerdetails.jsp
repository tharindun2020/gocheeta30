                    ...
                    <div class="page-title-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Customer details</li>
                            </ol>
                        </nav>
                    </div>
                                                    ...
                                                    <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Email</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  ></th>
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                Criteria procri = ss2.createCriteria(POJO.Users.class);

                                                                List<POJO.Users> available_veh = procri.list();

                                                                for (POJO.Users avbz : available_veh) {
                                                            %>
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td><%= avbz.getNamez() %></td>
                                                                <td><%= avbz.getNicz() %></td>
                                                                <td><%= avbz.getContacttz() %></td>
                                                                <td><%= avbz.getEmailz() %></td>
                                                                <td><input type="button" value="Remove" class="btn btn-danger" onclick="Removeuserz(<%= avbz.getId() %>)"></td>
