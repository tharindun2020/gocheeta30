                    ...
                    <div class="page-title-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Vehicle type details</li>
                            </ol>
                        </nav>
                    </div>
                                                    ...
                                                    <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  >Delivery cost</th>
                                                                <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1"  ></th>
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                Criteria procri = ss2.createCriteria(POJO.Vehicletypez.class);

                                                                List<POJO.Vehicletypez> available_veh = procri.list();

                                                                for (POJO.Vehicletypez avbz : available_veh) {
                                                            %>
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td><%= avbz.getVehid()%></td>
                                                                <td><%= avbz.getVehtype()%></td>
                                                                <td><%= avbz.getCosta()%></td>
                                                                <td><input type="button" value="Remove" class="btn btn-danger" onclick="removevehtype(<%= avbz.getVehid()%>)"></td>
                                                                        ...
                                                                        function removevehtype(gg) {
                                                                            ...
                                                                            function(data, status) {
                                                                                if (data == "alread") {
                                                                                    ...
                                                                                    swal("Done!Vehicle type Removed..!", {
                                                                                        icon: "success",
                                                                                    });
                                                                                    window.location = "Vehicletypedataz.jsp";
                                                                                }
                                                                                else {
