                    ...
                    <div class="page-title-wrapper">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">All Branches details</li>
                            </ol>
                        </nav>
                    </div>
                                                    ...
                                                    <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                Criteria procri = ss2.createCriteria(POJO.Branches.class);

                                                                List<POJO.Branches> available_veh = procri.list();

                                                                for (POJO.Branches avbz : available_veh) {
                                                            %>
                                                            <tr role="row" class="odd">
                                                                ...
                                                                <td><%= avbz.getId() %></td>
                                                                <td><%= avbz.getBranchname() %></td>
                                                                <td><input type="button" value="Remove" class="btn btn-danger" onclick="Remocebranch(<%= avbz.getId() %>)"></td>
                ...
                $.post("../RemoveBranch",
                        ...
                        function(data, status) {
                            if (data == "alread") {
                                ...
                                swal("Done!Branch Removed..!", {
                                    icon: "success",
                                });
                                window.location = "branchDetails.jsp";
                            }
                            else {
