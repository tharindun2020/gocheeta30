                            ...
                            <div class="modcontent">
                                <div class="box-category">
                                    <ul id="cat_accordion" class="list-group">
                                        ...
                                        %>
                                        <li class="hadchild">
                                            <a  class="cutom-parent" id="lodz2<%= brnz223.getVehid() %>" onclick="loadchesearchtypez2(<%= brnz223.getVehid() %>)"><%= brnz223.getVehtype()%></a>   <span class="button-view  fa fa-car"></span>
